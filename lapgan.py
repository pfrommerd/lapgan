...
def build_lapgan(generators, discriminators, generate_base=True, name="lapgan"):
...
def make_lapgan_targets(num_layers, num_samples):
    ...
    # Now tile the targets, in the horizontal direction by the number of layers
    # and in the vertical direction by the number of samples we need
    return np.tile(targets, (num_samples, num_layers))
